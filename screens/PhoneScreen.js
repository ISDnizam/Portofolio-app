  ...
  render() {
    ...
    <View style={styles.card2}>
      <View style={{position: 'absolute'}}>
        <Text  style={{marginBottom: 75,marginLeft: 10,marginTop: 10,color:'#918e8e'}}>TOTAL INCOMING</Text>
      </View>
      ...
      <View style={{flex: 2.5, flexDirection: 'column',marginTop: 20}}>
       ...
       {this.currencyFormat(this.state.dataSource.monthly_incoming)}
       </Text>
      </View>
      <View style={{flex: 2.5, flexDirection: 'column',marginTop: 20}}>
       <Text style={{color:'#918e8e'}}>ALL INCOMING </Text>
       <Text style={{fontWeight :'600'}} >
       {this.currencyFormat(this.state.dataSource.all_incoming)}
       </Text>
      </View>
    </View>
